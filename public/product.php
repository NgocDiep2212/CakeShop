...
<body style="">
	...
	<div class="promotion_bakery_area ">
			<h1 class="nav justify-content-center font-weight-bolder font-italic text-warning ">MENU</h1>
	</div>
	...
	<div class="row product_inner_row">
		...
		<div class="col-lg-9">
			<div class="products-container  row ">
					<?php
						...
						if (mysqli_num_rows($result) > 0) {
							while($row = mysqli_fetch_assoc($result)) {
								...
								echo 			'<a href="product/detail.php?id=' . $row['id'] . '">Xem thêm</a>';
								echo 		'</div>';
								echo 	'</div>';
								echo '</div>';
							}
					...
					<ul class="pagination justify-content-center pagination-lg-3">
						<li class="page-item nav-dark"><a class="page-link" href="#">Trước</a></li>
		...
		<aside class="left_sidebar p_catgories_widget">
			...
			<div>
				<ul class="navbar-nav list_style">
					<li><a href="product/Banhngot.php">Bánh Sinh Nhật</a></li>
					<li><a href="product/Banhmi.php">Bánh Mì</a></li>
					<li><a href="product/Banhman.php">Bánh Mặn</a></li>
					<li><a href="product/cookie.php">Cookie</a></li>
					<li><a href="product/minicake.php">Mincake</a></li>
				</ul>
			</div>
		</aside>
		</div>
